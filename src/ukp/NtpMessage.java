...
public class NtpMessage {
    ...
    public static double decodeTimestamp(byte[] array, int pointer) {
        ...
        for (int i = 0; i < 8; i++) {
            r += unsignedByteToShort(array[pointer + i]) * base[i];
        }
    ...
    public static void encodeTimestamp(byte[] array, int pointer,
        ...
        for (int i = 0; i < 8; i++) {
            ...
            // Capture byte value
            array[pointer + i] = (byte) (timestamp / base[i]);

            // Subtract captured value from remaining total
            timestamp = timestamp
                    - (double) (unsignedByteToShort(array[pointer + i]) * base[i]);
        }
    ...
    public static String timestampToString(double timestamp) {
        ...
        // date/time
        String date = "" + new Date(ms);

        // fraction
        double fraction = timestamp - ((long) timestamp);
        String fractionSting = ", fraction " + fraction;
